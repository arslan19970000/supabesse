...
const nav = [
  ...
  { href: '/dashboard/seller/products/add', label: 'Add Product', Icon: PlusCircle },
  { href: '/dashboard/seller/products', label: 'Products', Icon: List }
]
...
export default function SellerSidebar() {
  ...
  const handleLogout = async () => {
    ...
    router.push('/auth/login') // logout ke baad login page par bhej do
  }
  ...
  return (
    <aside className="h-screen sticky top-0 w-72 bg-white border-r flex flex-col">
      <div className="p-6 border-b flex items-center gap-2">
        ...
        <Link href="/dashboard/seller" className="text-xl font-semibold hover:underline">
          Seller Panel
        </Link>
      </div>
